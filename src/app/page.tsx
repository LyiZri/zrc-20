...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <section className='flex justify-between flex-col lg:flex-row w-full gap-14'>
        <div className='flex-1 flex justify-between flex-col gap-7'>
            ...
            <h2 className='text-white text-3xl'>ZRC-420</h2>
            <div className='flex justify-between'>
              <Line percent={0} strokeWidth={1} trailColor="#222224" strokeColor="#6AD09D" />
            </div>
            <ul className='border text-[#fafafa] border-[#27272a] p-6 rounded-[10px] flex flex-col gap-9'>
              ...
              <li className='w-full flex justify-between text-sm'>
                <span className='opacity-50'>Your ZRC-420</span>
                <span>0</span>
              </li>
            </ul>
          </div>
